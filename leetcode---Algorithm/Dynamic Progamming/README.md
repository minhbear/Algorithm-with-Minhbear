This is place to push soution in tag Dynamic Progamming, The number in folder is a ID of exercise in leetCode, you can type ID in there to see the exercise
